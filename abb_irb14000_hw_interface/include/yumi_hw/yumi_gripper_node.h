...
private:
  ...
  bool request_grasp(abb_irb14000_msgs::YumiGrasp::Request  &req, abb_irb14000_msgs::YumiGrasp::Response &res)
  {
  ...
  bool request_release(abb_irb14000_msgs::YumiGrasp::Request  &req, abb_irb14000_msgs::YumiGrasp::Response &res)
  {
    float left=0, right=0;
    if(req.gripper_id == LEFT_GRIPPER) 
    {
